...
![](developing_new_terrains_godot_import_fbx.png)
...
![](developing_new_maps_world_environment.png)

![](developing_new_maps_world_environment2.png)

Also add a DirectionalLight3D node, which will generate the shadows later.

![](developing_new_maps_lighting.png)
...
![](developing_new_maps_collision_surfaces1.png)

![](developing_new_maps_collision_surfaces2.png)
...
![](developing_new_maps_navmesh3.png)
...
![](developing_new_maps_navmesh4.png)
...
![](developing_new_maps_surfaces_obstacles.png)
...
![](developing_new_maps_static_objects1.png)
...
![](developing_new_maps_static_objects2.png)

You're done, the map is complete and can now be used in a [playable scene](4_developing_new_playable_scenes.md)
