...
Export the same way you exported a terrain in [developing_new_terrains](developing_new_terrains.md), but this time in folder `src://src/objects/sports/gltf/cone.gltf`. Godot will import it.
...
![](images/developing_new_static_objects_final_godot.png)
